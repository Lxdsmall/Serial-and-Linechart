...
enum : int {
    ...
    SBK_QT3DRENDER_PROPERTYREADERINTERFACE_IDX               = 6,
    SBK_QT3DRENDER_QABSTRACTFUNCTOR_IDX                      = 7,
    SBK_QT3DRENDER_QABSTRACTLIGHT_IDX                        = 8,
    SBK_QT3DRENDER_QABSTRACTLIGHT_TYPE_IDX                   = 9,
    SBK_QT3DRENDER_QABSTRACTRAYCASTER_IDX                    = 10,
    SBK_QT3DRENDER_QABSTRACTRAYCASTER_RUNMODE_IDX            = 12,
    SBK_QT3DRENDER_QABSTRACTRAYCASTER_FILTERMODE_IDX         = 11,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_IDX                      = 13,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_STATUS_IDX               = 18,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_TARGET_IDX               = 19,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_TEXTUREFORMAT_IDX        = 20,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_FILTER_IDX               = 17,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_CUBEMAPFACE_IDX          = 16,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_COMPARISONFUNCTION_IDX   = 14,
    SBK_QT3DRENDER_QABSTRACTTEXTURE_COMPARISONMODE_IDX       = 15,
    SBK_QT3DRENDER_QABSTRACTTEXTUREIMAGE_IDX                 = 21,
    SBK_QT3DRENDER_QALPHACOVERAGE_IDX                        = 22,
    SBK_QT3DRENDER_QALPHATEST_IDX                            = 23,
    SBK_QT3DRENDER_QALPHATEST_ALPHAFUNCTION_IDX              = 24,
    SBK_QT3DRENDER_QATTRIBUTE_IDX                            = 25,
    SBK_QT3DRENDER_QATTRIBUTE_ATTRIBUTETYPE_IDX              = 26,
    SBK_QT3DRENDER_QATTRIBUTE_VERTEXBASETYPE_IDX             = 27,
    SBK_QT3DRENDER_QBLENDEQUATION_IDX                        = 28,
    SBK_QT3DRENDER_QBLENDEQUATION_BLENDFUNCTION_IDX          = 29,
    SBK_QT3DRENDER_QBLENDEQUATIONARGUMENTS_IDX               = 30,
    SBK_QT3DRENDER_QBLENDEQUATIONARGUMENTS_BLENDING_IDX      = 31,
    SBK_QT3DRENDER_QBLITFRAMEBUFFER_IDX                      = 32,
    SBK_QT3DRENDER_QBLITFRAMEBUFFER_INTERPOLATIONMETHOD_IDX  = 33,
    SBK_QT3DRENDER_QBUFFER_IDX                               = 34,
    SBK_QT3DRENDER_QBUFFER_BUFFERTYPE_IDX                    = 36,
    SBK_QT3DRENDER_QBUFFER_USAGETYPE_IDX                     = 37,
    SBK_QT3DRENDER_QBUFFER_ACCESSTYPE_IDX                    = 35,
    SBK_QT3DRENDER_QBUFFERCAPTURE_IDX                        = 38,
    SBK_QT3DRENDER_QBUFFERDATAGENERATOR_IDX                  = 39,
    SBK_QT3DRENDER_QCAMERA_IDX                               = 40,
    SBK_QT3DRENDER_QCAMERA_CAMERATRANSLATIONOPTION_IDX       = 41,
    SBK_QT3DRENDER_QCAMERALENS_IDX                           = 42,
    SBK_QT3DRENDER_QCAMERALENS_PROJECTIONTYPE_IDX            = 43,
    SBK_QT3DRENDER_QCAMERASELECTOR_IDX                       = 44,
    SBK_QT3DRENDER_QCLEARBUFFERS_IDX                         = 45,
    SBK_QT3DRENDER_QCLEARBUFFERS_BUFFERTYPE_IDX              = 46,
    SBK_QFLAGS_QT3DRENDER_QCLEARBUFFERS_BUFFERTYPE_IDX       = 0,
    SBK_QT3DRENDER_QCLIPPLANE_IDX                            = 47,
    SBK_QT3DRENDER_QCOLORMASK_IDX                            = 48,
    SBK_QT3DRENDER_QCOMPUTECOMMAND_IDX                       = 49,
    ...
    SBK_QT3DRENDER_QSHADERPROGRAM_IDX                        = 131,
    SBK_QT3DRENDER_QSHADERPROGRAM_SHADERTYPE_IDX             = 132,
    SBK_QT3DRENDER_QSHADERPROGRAM_STATUS_IDX                 = 133,
    SBK_QT3DRENDER_QSHADERPROGRAMBUILDER_IDX                 = 134,
    SBK_QT3DRENDER_QSORTPOLICY_IDX                           = 135,
    SBK_QT3DRENDER_QSORTPOLICY_SORTTYPE_IDX                  = 136,
    SBK_QT3DRENDER_QSPOTLIGHT_IDX                            = 137,
    SBK_QT3DRENDER_QSTENCILMASK_IDX                          = 138,
    SBK_QT3DRENDER_QSTENCILOPERATION_IDX                     = 139,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_IDX            = 140,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_FACEMODE_IDX   = 141,
    SBK_QT3DRENDER_QSTENCILOPERATIONARGUMENTS_OPERATION_IDX  = 142,
    SBK_QT3DRENDER_QSTENCILTEST_IDX                          = 143,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_IDX                 = 144,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFACEMODE_IDX = 145,
    SBK_QT3DRENDER_QSTENCILTESTARGUMENTS_STENCILFUNCTION_IDX = 146,
    SBK_QT3DRENDER_QTECHNIQUE_IDX                            = 147,
    SBK_QT3DRENDER_QTECHNIQUEFILTER_IDX                      = 148,
    SBK_QT3DRENDER_QTEXTURE1D_IDX                            = 149,
    SBK_QT3DRENDER_QTEXTURE1DARRAY_IDX                       = 150,
    SBK_QT3DRENDER_QTEXTURE2D_IDX                            = 151,
    SBK_QT3DRENDER_QTEXTURE2DARRAY_IDX                       = 152,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLE_IDX                 = 153,
    SBK_QT3DRENDER_QTEXTURE2DMULTISAMPLEARRAY_IDX            = 154,
    SBK_QT3DRENDER_QTEXTURE3D_IDX                            = 155,
    SBK_QT3DRENDER_QTEXTUREBUFFER_IDX                        = 156,
    SBK_QT3DRENDER_QTEXTURECUBEMAP_IDX                       = 157,
    SBK_QT3DRENDER_QTEXTURECUBEMAPARRAY_IDX                  = 158,
    SBK_QT3DRENDER_QTEXTUREDATA_IDX                          = 159,
    SBK_QT3DRENDER_QTEXTUREGENERATOR_IDX                     = 160,
    SBK_QT3DRENDER_QTEXTUREIMAGE_IDX                         = 161,
    SBK_QT3DRENDER_QTEXTUREIMAGE_STATUS_IDX                  = 162,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATA_IDX                     = 163,
    SBK_QT3DRENDER_QTEXTUREIMAGEDATAGENERATOR_IDX            = 164,
    SBK_QT3DRENDER_QTEXTURELOADER_IDX                        = 165,
    SBK_QT3DRENDER_QTEXTURERECTANGLE_IDX                     = 166,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_IDX                      = 167,
    SBK_QT3DRENDER_QTEXTUREWRAPMODE_WRAPMODE_IDX             = 168,
    SBK_QT3DRENDER_QVIEWPORT_IDX                             = 169,
