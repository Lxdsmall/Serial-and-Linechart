...
// Type indices
enum : int {
    SBK_QWEBENGINECOOKIESTORE_IDX                            = 0,
    SBK_QWEBENGINEHTTPREQUEST_IDX                            = 1,
    SBK_QWEBENGINEHTTPREQUEST_METHOD_IDX                     = 2,
    SBK_QWEBENGINEURLREQUESTINFO_IDX                         = 3,
    SBK_QWEBENGINEURLREQUESTINFO_RESOURCETYPE_IDX            = 5,
    SBK_QWEBENGINEURLREQUESTINFO_NAVIGATIONTYPE_IDX          = 4,
    SBK_QWEBENGINEURLREQUESTINTERCEPTOR_IDX                  = 6,
    SBK_QWEBENGINEURLREQUESTJOB_IDX                          = 7,
    SBK_QWEBENGINEURLREQUESTJOB_ERROR_IDX                    = 8,
    SBK_QWEBENGINEURLSCHEMEHANDLER_IDX                       = 9,
    SBK_QtWebEngineCore_IDX_COUNT                            = 10
};
