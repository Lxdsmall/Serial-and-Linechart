...
enum : int {
    ...
    SBK_QWEBENGINEDOWNLOADITEM_SAVEPAGEFORMAT_IDX            = 12,
    SBK_QWEBENGINEDOWNLOADITEM_DOWNLOADINTERRUPTREASON_IDX   = 10,
    SBK_QWEBENGINEFULLSCREENREQUEST_IDX                      = 13,
    SBK_QWEBENGINEHISTORYITEM_IDX                            = 14,
    SBK_QWEBENGINEPAGE_IDX                                   = 15,
    SBK_QWEBENGINEPAGE_WEBACTION_IDX                         = 23,
    SBK_QWEBENGINEPAGE_FINDFLAG_IDX                          = 18,
    SBK_QFLAGS_QWEBENGINEPAGE_FINDFLAG_IDX                   = 2,
    SBK_QWEBENGINEPAGE_WEBWINDOWTYPE_IDX                     = 24,
    SBK_QWEBENGINEPAGE_PERMISSIONPOLICY_IDX                  = 21,
    SBK_QWEBENGINEPAGE_NAVIGATIONTYPE_IDX                    = 20,
    SBK_QWEBENGINEPAGE_FEATURE_IDX                           = 16,
    SBK_QWEBENGINEPAGE_FILESELECTIONMODE_IDX                 = 17,
    SBK_QWEBENGINEPAGE_JAVASCRIPTCONSOLEMESSAGELEVEL_IDX     = 19,
    SBK_QWEBENGINEPAGE_RENDERPROCESSTERMINATIONSTATUS_IDX    = 22,
    SBK_QWEBENGINEPROFILE_IDX                                = 25,
    SBK_QWEBENGINEPROFILE_HTTPCACHETYPE_IDX                  = 26,
    SBK_QWEBENGINEPROFILE_PERSISTENTCOOKIESPOLICY_IDX        = 27,
    SBK_QWEBENGINESCRIPT_IDX                                 = 28,
    SBK_QWEBENGINESCRIPT_INJECTIONPOINT_IDX                  = 29,
    SBK_QWEBENGINESCRIPT_SCRIPTWORLDID_IDX                   = 30,
    SBK_QWEBENGINESCRIPTCOLLECTION_IDX                       = 31,
    SBK_QWEBENGINESETTINGS_IDX                               = 32,
    SBK_QWEBENGINESETTINGS_FONTFAMILY_IDX                    = 33,
    SBK_QWEBENGINESETTINGS_WEBATTRIBUTE_IDX                  = 36,
    SBK_QWEBENGINESETTINGS_FONTSIZE_IDX                      = 34,
    SBK_QWEBENGINESETTINGS_UNKNOWNURLSCHEMEPOLICY_IDX        = 35,
    SBK_QWEBENGINEVIEW_IDX                                   = 37,
    SBK_QtWebEngineWidgets_IDX_COUNT                         = 38
};
...
enum : int {
    ...
    SBK_QTWEBENGINEWIDGETS_QLIST_QURL_IDX                    = 2, // const QList<QUrl > &
    SBK_QTWEBENGINEWIDGETS_QLIST_QWEBENGINESCRIPT_IDX        = 3, // QList<QWebEngineScript >
    SBK_QTWEBENGINEWIDGETS_QLIST_QACTIONPTR_IDX              = 4, // QList<QAction* >
    SBK_QTWEBENGINEWIDGETS_QLIST_QVARIANT_IDX                = 5, // QList<QVariant >
    SBK_QTWEBENGINEWIDGETS_QLIST_QSTRING_IDX                 = 6, // QList<QString >
    SBK_QTWEBENGINEWIDGETS_QMAP_QSTRING_QVARIANT_IDX         = 7, // QMap<QString,QVariant >
