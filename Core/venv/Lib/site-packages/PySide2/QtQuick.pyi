...
class QQuickItem(PySide2.QtCore.QObject, PySide2.QtQml.QQmlParserStatus):
    ...
    def childItems(self) -> PySide2.QtQuick.QQuickItem: ...
    ...
    def grabTouchPoints(self, ids:list): ...
...
class QSGGeometry(Shiboken.Object):
    ...
    class ColoredPoint2D(Shiboken.Object):
        ...
        def __copy__(self): ...
        def set(self, nx:float, ny:float, nr:typing.Union[str, int], ng:typing.Union[str, int], nb:typing.Union[str, int], na:typing.Union[str, int]): ...
