...
class QAxBase(Shiboken.Object):
    ...
    @staticmethod
    def argumentsToList(var1:typing.Any, var2:typing.Any, var3:typing.Any, var4:typing.Any, var5:typing.Any, var6:typing.Any, var7:typing.Any, var8:typing.Any) -> typing.Any: ...
    ...
    @typing.overload
    def dynamicCall(self, name:str, vars:list) -> typing.Any: ...
    @typing.overload
    def dynamicCall(self, name:str, vars:list, flags:int) -> typing.Any: ...
    ...
    @typing.overload
    def querySubObject(self, name:str, vars:list) -> PySide2.QtAxContainer.QAxObject: ...
    def setControl(self, arg__1:str) -> bool: ...
    def setPropertyBag(self, arg__1:dict): ...
...
class QAxScript(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def call(self, function:str, arguments:list) -> typing.Any: ...
    @typing.overload
