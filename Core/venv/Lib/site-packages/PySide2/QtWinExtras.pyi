...
class QWinJumpList(PySide2.QtCore.QObject):
    ...
    @typing.overload
    def addCategory(self, title:str, items:list=...) -> PySide2.QtWinExtras.QWinJumpListCategory: ...
    def categories(self) -> PySide2.QtWinExtras.QWinJumpListCategory: ...
    def clear(self): ...
...
class QWinJumpListCategory(Shiboken.Object):
    ...
    def items(self) -> PySide2.QtWinExtras.QWinJumpListItem: ...
...
class QWinThumbnailToolBar(PySide2.QtCore.QObject):
    ...
    def buttons(self) -> PySide2.QtWinExtras.QWinThumbnailToolButton: ...
    def clear(self): ...
    def count(self) -> int: ...
